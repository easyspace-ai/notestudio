...
/example\.(net|org)/`,
  ...
  agentEditor: {
    ...
    tools: {
      ...
      readFileDesc: 'Чтение файлов в рабочей области сессии или /mnt/user-data, /mnt/skills',
      writeFile: 'Запись файла',
      writeFileDesc: 'Запись в /mnt/user-data или относительные пути (skills/ACP только чтение)',
      strReplace: 'Замена в файле',
      strReplaceDesc: 'Замена строк в существующем файле',
      ls: 'Список каталога',
      lsDesc: 'Содержимое каталога (неглубокое дерево)',
      glob: 'Glob',
      globDesc: 'Список файлов по шаблону glob',
      bash: 'Shell',
      bashDesc: 'Разрешённые команды в рабочей области (осторожно в проде)',
      task: 'Подзадача',
      taskDesc: 'Делегирование субагенту (general-purpose или bash)',
      viewImage: 'Просмотр изображения',
      viewImageDesc: 'Загрузка изображения для зрительных моделей',
      toolSearch: 'Поиск инструментов',
      toolSearchDesc: 'Поиск встроенных инструментов по ключевым словам',
      invokeAcp: 'Внешний ACP-агент',
      invokeAcpDesc: 'Команда из WEKNORA_ACP_AGENTS_JSON',
      setupAgent: 'Черновик агента',
      setupAgentDesc: 'YAML-черновик в /mnt/user-data/agent-drafts',
