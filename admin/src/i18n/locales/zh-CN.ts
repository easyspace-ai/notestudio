export default {
  ...
  agentEditor: {
    ...
    tools: {
      ...
      readFile: "读取文件",
      readFileDesc: "读取会话工作区或虚拟路径 /mnt/user-data、/mnt/skills 下的文件",
      writeFile: "写入文件",
      writeFileDesc: "写入 /mnt/user-data 或工作区相对路径（技能与 ACP 目录只读）",
      strReplace: "替换文件内容",
      strReplaceDesc: "在已存在的文件中进行字符串替换",
      ls: "列出目录",
      lsDesc: "列出目录内容（树形浅层）",
      glob: "文件匹配",
      globDesc: "使用 glob 模式列出匹配文件",
      bash: "Shell 命令",
      bashDesc: "在会话工作区执行白名单命令（生产环境请谨慎开启）",
      task: "子任务",
      taskDesc: "委托子代理执行独立任务（general-purpose 或 bash）",
      viewImage: "查看图片",
      viewImageDesc: "加载图片到工具结果供视觉模型分析",
      toolSearch: "工具搜索",
      toolSearchDesc: "按关键词搜索内置工具名称与描述",
      invokeAcp: "外部 ACP 代理",
      invokeAcpDesc: "调用 WEKNORA_ACP_AGENTS_JSON 配置的外部命令",
      setupAgent: "保存智能体草稿",
      setupAgentDesc: "将 soul/描述写入 /mnt/user-data/agent-drafts YAML 草稿",
      requiresKb: "（需要配置知识库）",
    },
    mcp: {
      label: "MCP 服务",
