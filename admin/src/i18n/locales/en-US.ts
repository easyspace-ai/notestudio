...
\
  ...
  agentEditor: {
    ...
    tools: {
      ...
      readFile: 'Read file',
      readFileDesc: 'Read files under session workspace or virtual paths /mnt/user-data, /mnt/skills',
      writeFile: 'Write file',
      writeFileDesc: 'Write under /mnt/user-data or workspace-relative paths (skills and ACP are read-only)',
      strReplace: 'Str replace',
      strReplaceDesc: 'Replace strings in an existing file',
      ls: 'List directory',
      lsDesc: 'List directory contents (shallow tree)',
      glob: 'Glob files',
      globDesc: 'List paths matching a glob pattern',
      bash: 'Shell',
      bashDesc: 'Run allowlisted shell commands in session workspace (use with caution in production)',
      task: 'Subtask',
      taskDesc: 'Delegate to a sub-agent (general-purpose or bash-only)',
      viewImage: 'View image',
      viewImageDesc: 'Load an image into tool results for vision models',
      toolSearch: 'Tool search',
      toolSearchDesc: 'Search built-in tool names and descriptions by keyword',
      invokeAcp: 'External ACP agent',
      invokeAcpDesc: 'Run a command from WEKNORA_ACP_AGENTS_JSON',
      setupAgent: 'Save agent draft',
      setupAgentDesc: 'Write soul/description YAML under /mnt/user-data/agent-drafts',
