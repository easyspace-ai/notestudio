export default {
  ...
  agentEditor: {
    ...
    tools: {
      ...
      readFile: '파일 읽기',
      readFileDesc: '세션 작업 공간 또는 /mnt/user-data, /mnt/skills 경로에서 파일 읽기',
      writeFile: '파일 쓰기',
      writeFileDesc: '/mnt/user-data 또는 작업 공간 상대 경로에 쓰기(스킬/ACP는 읽기 전용)',
      strReplace: '문자열 치환',
      strReplaceDesc: '기존 파일에서 문자열 치환',
      ls: '디렉터리 목록',
      lsDesc: '디렉터리 내용 나열(얕은 트리)',
      glob: 'Glob',
      globDesc: 'glob 패턴으로 파일 목록',
      bash: 'Shell',
      bashDesc: '허용 목록 명령을 작업 공간에서 실행(프로덕션 주의)',
      task: '하위 작업',
      taskDesc: '하위 에이전트에 위임(general-purpose 또는 bash)',
      viewImage: '이미지 보기',
      viewImageDesc: '비전 모델용 이미지 로드',
      toolSearch: '도구 검색',
      toolSearchDesc: '키워드로 내장 도구 검색',
      invokeAcp: '외부 ACP 에이전트',
      invokeAcpDesc: 'WEKNORA_ACP_AGENTS_JSON에 설정된 명령 실행',
      setupAgent: '에이전트 초안 저장',
      setupAgentDesc: '/mnt/user-data/agent-drafts에 YAML 초안 저장',
