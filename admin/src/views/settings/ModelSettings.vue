<template>
  <div class="model-settings">
    <div class="section-header">
      ...
      <!-- 终端租户视角的内置模型说明（平台管理员在全局模型页可直接管理内置模型） -->
      <div v-if="!platformMode()" class="builtin-models-info">
        <div class="info-box">
...
const { t } = useI18n()
const platformMode = () => isPlatformConsole()
...
const editModel = (type: 'chat' | 'embedding' | 'rerank' | 'vllm' | 'asr', model: any) => {
  if (!platformMode() && model.isBuiltin) {
