...
const allTools = computed(() => [
  ...
  { value: 'read_file', label: t('agentEditor.tools.readFile'), description: t('agentEditor.tools.readFileDesc'), requiresKB: false },
  { value: 'write_file', label: t('agentEditor.tools.writeFile'), description: t('agentEditor.tools.writeFileDesc'), requiresKB: false },
  { value: 'str_replace', label: t('agentEditor.tools.strReplace'), description: t('agentEditor.tools.strReplaceDesc'), requiresKB: false },
  { value: 'ls', label: t('agentEditor.tools.ls'), description: t('agentEditor.tools.lsDesc'), requiresKB: false },
  { value: 'glob', label: t('agentEditor.tools.glob'), description: t('agentEditor.tools.globDesc'), requiresKB: false },
  { value: 'bash', label: t('agentEditor.tools.bash'), description: t('agentEditor.tools.bashDesc'), requiresKB: false },
  { value: 'task', label: t('agentEditor.tools.task'), description: t('agentEditor.tools.taskDesc'), requiresKB: false },
  { value: 'view_image', label: t('agentEditor.tools.viewImage'), description: t('agentEditor.tools.viewImageDesc'), requiresKB: false },
  { value: 'tool_search', label: t('agentEditor.tools.toolSearch'), description: t('agentEditor.tools.toolSearchDesc'), requiresKB: false },
  { value: 'invoke_acp_agent', label: t('agentEditor.tools.invokeAcp'), description: t('agentEditor.tools.invokeAcpDesc'), requiresKB: false },
  { value: 'setup_agent', label: t('agentEditor.tools.setupAgent'), description: t('agentEditor.tools.setupAgentDesc'), requiresKB: false },
]);
