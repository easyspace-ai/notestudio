...
import { mergeWithWeKnoraUrlTransform } from "@/core/streamdown/plugins";
...
export const MessageContent = ({
  ...
  <div
    className={cn(
      ...
      "group-[.is-user]:bg-transparent group-[.is-user]:text-foreground group-[.is-user]:ml-auto group-[.is-user]:rounded-lg group-[.is-user]:px-4 group-[.is-user]:py-3",
...
export const MessageResponse = memo(
  ({ className, urlTransform, ...props }: MessageResponseProps) => (
    <Streamdown
      ...
      urlTransform={mergeWithWeKnoraUrlTransform(urlTransform)}
      {...props}
    />
  ),
