...
type AsynqTaskParams struct {
	...
	StudioWorker         interfaces.TaskHandler `name:"studioWorker"`
}
...
func RunAsynqServer(params AsynqTaskParams) *asynq.ServeMux {
	...
	// MetaNote Studio async generation
	mux.HandleFunc(types.TypeStudioGenerate, params.StudioWorker.Handle)
