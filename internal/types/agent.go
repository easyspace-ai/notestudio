...
type AgentConfig struct {
	...
	// ReadFileOutputMaxChars caps read_file tool output (0 = use registry DefaultMaxToolOutput only).
	ReadFileOutputMaxChars int `json:"read_file_output_max_chars,omitempty"`
	// BashOutputMaxChars caps bash stdout+stderr in tool JSON (0 = no extra cap beyond registry).
	BashOutputMaxChars int `json:"bash_output_max_chars,omitempty"`
}
