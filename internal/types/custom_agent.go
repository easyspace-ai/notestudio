...
type CustomAgentConfig struct {
	...
	// ReadFileOutputMaxChars caps read_file output (0 = registry default only).
	ReadFileOutputMaxChars int `yaml:"read_file_output_max_chars" json:"read_file_output_max_chars,omitempty"`
	// BashOutputMaxChars caps bash JSON output size (0 = no extra cap).
	BashOutputMaxChars int `yaml:"bash_output_max_chars" json:"bash_output_max_chars,omitempty"`
