...
type KnowledgeBaseRepository interface {
	...
	// ListAllNonTemporaryForAdmin lists all non-temporary knowledge bases (platform admin).
	ListAllNonTemporaryForAdmin(ctx context.Context) ([]*types.KnowledgeBase, error)
